...
YueBaoLoginType loginType = SINA;


NSString *const kSinaWeiboAppKey  = @"1415947087";
NSString *const kSinaWeiboAppSecret = @"c37200013396910c48522753cd9c398f";

NSString *const kUMengAppKey = @"502499096c738f264d000001";

//DEV
NSString *const kUpyunImageDownloadURL = @"http://themoment.b0.upaiyun.com";
NSString *const kUpyunImageBuket = @"themoment";
NSString *const kUpyunImagePasscode = @"6EShEJfhmQQDNUW/cDaZUoTEBmc=";

//Product
//NSString *const kUpyunImageDownloadURL = @"http://themomentproduct.b0.upaiyun.com";
//NSString *const kUpyunImageBuket = @"themomentproduct";
//NSString *const kUpyunImagePasscode = @"STJoVlew/O64StfEBmY8Xnff1eQ=";
...
NSString *const kPAPUserDefaultsCacheSinaFriendsKey                     = @"com.parse.Anypic.userDefaults.cache.sinaFriends";
...
NSString *const kPAPUserAvatarURL                               = @"avatarURL";
NSString *const kPAPUserFacebookIDKey                           = @"facebookId";
NSString *const kPAPUserSinaIDKey                           = @"sinaId";
NSString *const kPAPUserSinaAccessToken                           = @"sinaAccessToken";
...
NSString *const kPAPUserAlreadyAutoFollowedSinaFriendsKey   = @"userAlreadyAutoFollowedSinaFriends";
...
// Field keys
NSString *const kPAPPhotoPictureURLKey      = @"imageURL";
NSString *const kPAPPhotoPictureWidthKey      = @"width";
NSString *const kPAPPhotoPictureHeightKey      = @"height";
NSString *const kPAPPhotoThumbnailURLKey    = @"thumbnailImageURL";
