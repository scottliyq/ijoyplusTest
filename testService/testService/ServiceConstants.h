...
extern YueBaoLoginType loginType;
...
extern NSString *const kUpyunImageDownloadURL;
extern NSString *const kUpyunImageBuket;
extern NSString *const kUpyunImagePasscode;
...
extern NSString *const kPAPUserDefaultsCacheSinaFriendsKey;
...
extern NSString *const kPAPUserAvatarURL;
extern NSString *const kPAPUserFacebookIDKey;
extern NSString *const kPAPUserSinaIDKey;
extern NSString *const kPAPUserSinaAccessToken;
...
extern NSString *const kPAPUserAlreadyAutoFollowedSinaFriendsKey;
...
// Field keys
extern NSString *const kPAPPhotoPictureURLKey;
extern NSString *const kPAPPhotoPictureWidthKey;
extern NSString *const kPAPPhotoPictureHeightKey;
extern NSString *const kPAPPhotoThumbnailURLKey;
